            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7 col-sm-9">
                    <div class="inner_banner_content text-center">
                        ...
                        <p class="text-white inner_banner_text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos voluptatem maxime magnam quae maiores ullam velit temporibus repellendus illum molestiae assumenda ad porro enim, laboriosam, eligendi, excepturi autem iusto. Similique.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="details_content">
                        ...
                        <p class="section_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit sint repellendus ea qui natus obcaecati adipisci aliquam recusandae? Eaque alias vero excepturi suscipit corrupti nemo asperiores maiores reiciendis aperiam dolor?</p>
                        <!-- list -->
                        <ul>
                            <li>
    ...
    <section class="section_padding">
        <div class="container">
            ...
            <div class="section_title">
                ...
                <!-- section text -->
                <p class="section_text">Get personalized web design and development solutions from us to enhance your personal and business visibility, growth, and engagement, today!</p>
            </div>
            <!-- service card -->
            <div class="row gy-4">
                <!-- single column -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card_service text-center">
                       ...
                       <h3 class="card_service_title">HRM Management</h3>
                       <p class="card_service_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quam soluta suscipit nostrum assumenda veniam. Provident animi, voluptates tempora consequuntur ratione sequi odit, explicabo esse nulla, quibusdam asperiores quod distinctio.</p>
                    </div>
                </div>
                <!-- single column -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card_service text-center">
                       <div class="card_service_image mx-auto">
                            <img src="assets/image/software/pos.png" alt="">
                       </div>
                       <h3 class="card_service_title">POS Management</h3>
                       <p class="card_service_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quam soluta suscipit nostrum assumenda veniam. Provident animi, voluptates tempora consequuntur ratione sequi odit, explicabo esse nulla, quibusdam asperiores quod distinctio.</p>
                    </div>
                </div>
                <!-- single column -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card_service text-center">
                       <div class="card_service_image mx-auto">
                            <img src="assets/image/software/cart.png" alt="">
                       </div>
                       <h3 class="card_service_title">Multi Vendor E-commerce</h3>
                       <p class="card_service_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quam soluta suscipit nostrum assumenda veniam. Provident animi, voluptates tempora consequuntur ratione sequi odit, explicabo esse nulla, quibusdam asperiores quod distinctio.</p>
                    </div>
                </div>
                <!-- single column -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card_service text-center">
                       <div class="card_service_image mx-auto">
                            <img src="assets/image/software/bus.png" alt="">
                       </div>
                       <h3 class="card_service_title">Bus Booking</h3>
                       <p class="card_service_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quam soluta suscipit nostrum assumenda veniam. Provident animi, voluptates tempora consequuntur ratione sequi odit, explicabo esse nulla, quibusdam asperiores quod distinctio.</p>
                    </div>
                </div>
                <!-- single column -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card_service text-center">
                       <div class="card_service_image mx-auto">
                            <img src="assets/image/software/airplane.png" alt="">
                       </div>
                       <h3 class="card_service_title">Flight book API</h3>
                       <p class="card_service_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quam soluta suscipit nostrum assumenda veniam. Provident animi, voluptates tempora consequuntur ratione sequi odit, explicabo esse nulla, quibusdam asperiores quod distinctio.</p>
                    </div>
                </div>
                <!-- single column -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card_service text-center">
                       <div class="card_service_image mx-auto">
                            <img src="assets/image/software/restaurant.png" alt="">
                       </div>
                       <h3 class="card_service_title">Restaurant Software</h3>
                       <p class="card_service_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quam soluta suscipit nostrum assumenda veniam. Provident animi, voluptates tempora consequuntur ratione sequi odit, explicabo esse nulla, quibusdam asperiores quod distinctio.</p>
                    </div>
                </div>
                <!-- single column -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card_service text-center">
                       <div class="card_service_image mx-auto">
                            <img src="assets/image/software/online-learning.png" alt="">
                       </div>
                       <h3 class="card_service_title">E-learning management</h3>
                       <p class="card_service_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quam soluta suscipit nostrum assumenda veniam. Provident animi, voluptates tempora consequuntur ratione sequi odit, explicabo esse nulla, quibusdam asperiores quod distinctio.</p>
                    </div>
                </div>
                <!-- single column -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card_service text-center">
                       <div class="card_service_image mx-auto">
                            <img src="assets/image/software/journal.png" alt="">
                       </div>
                       <h3 class="card_service_title">Newspaper</h3>
                       <p class="card_service_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quam soluta suscipit nostrum assumenda veniam. Provident animi, voluptates tempora consequuntur ratione sequi odit, explicabo esse nulla, quibusdam asperiores quod distinctio.</p>
                    </div>
                </div>
                <!-- single column -->
        ...
        <div class="container">
            ...
            <div class="indus_service_wrapper">
                ...
                <div class="indus_service_item">
                    <img src="{{asset('assets/images/uploads/industry-serve/' . $industryServe->icon)}}" alt="">
