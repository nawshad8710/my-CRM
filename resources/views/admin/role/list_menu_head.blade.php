                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Menu Head List</h3>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        <thead>
                                            <tr>
                                                <th>Menu Head Title</th>
                                                <th>Status</th>
                                                <th class="text-center">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @if(count($menu_heads) > 0)
                                                @foreach($menu_heads as $key => $menu_head)
                                                <tr class="tr-shadow">
                                                    <td>{{ $menu_head->title }}</td>
                                                    <td>
                                                        @if($menu_head->status == 1)
                                                    ...
                                                    <td class="text-center">
                                                        <div class="table-data-feature">
                                                            ...
                                                            <a href="{{ route('admin.role.menuHeadEdit', $menu_head->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <i class="zmdi zmdi-edit"></i>
                                                            </a>
                                                            @endif
                                                            @if(has_access('delete_menu_head'))
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Delete" onclick="deleteModalShow({{ $menu_head->id }})">
                                            ...
                                            @else
                                            <tr class="tr-shadow">
                                                <td colspan="8" class="text-center">No Menu Head Found!</td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
				...
				<div class="modal-dialog modal-sm" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="staticModalLabel">Delete Menu Head</h5>
						...
						<div class="modal-body">
							<p>
								Are you sure? All menus and permissions related to this will be deleted!
							</p>
