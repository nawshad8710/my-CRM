                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <a href="{{ route('admin.sales.product.add') }}" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                            ...
                                            @if(count($products) > 0)
                                                ...
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td class="desc">
                                                        ...
                                                        @if (strlen($description) > 30)
                                                            {{ $desc }}
                                                            <a href="#" class="desc-text" onclick="shortDescModalShow({{ $product->id }})"> <u>View Details</u></a>
                                                        @else
                                                            {!! $product->short_description !!}
                                                        @endif
                                                        <!-- {!! Str::limit($description, $limit = 30, $end = '. . .<a href="#" class="desc-text" onclick="descModalShow()">View Details</a>') !!} -->
                                                        <div id="short_description{{ $product->id }}" class="d-none">
                                                            {!! $product->short_description !!}
                                                        </div>
                                                    </td>
                                                    <td class="desc">
                                                        ...
                                                        @if (strlen($description) > 30)
                                                            {{ $desc }}
                                                            <a href="#" class="desc-text" onclick="longDescModalShow({{ $product->id }})"> <u>View Details</u></a>
                                                        @else
