                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Project List</h3>
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <a href="{{ route('admin.project.add') }}" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                        ...
                                        <tbody>
                                            @if(count($projects) > 0)
                                                ...
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td class="desc">
                                                        <?php 
                                                            $description =  strip_tags(html_entity_decode($project->description));
                                                        ...
                                                        @if (strlen($description) > 30)
                                                            {{ $desc }}
                                                            <a href="#" class="desc-text" onclick="descModalShow({{ $project->id }})"> <u>View Details</u></a>
                                                        @else
                                                            {{ $project->description }}
                                                        @endif
                                                        <!-- {!! Str::limit($description, $limit = 30, $end = '. . .<a href="#" class="desc-text" onclick="descModalShow()">View Details</a>') !!} -->
                                                        <div id="description{{ $project->id }}" class="d-none">
                                                            {!! $project->description !!}
                                                        </div>
                                                    </td>
                                                    <td>{{ date('d-m-Y H:i a', strtotime($project->deadline)) }}</td>
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            ...
                                                            <a href="{{ route('admin.project.edit', $project->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <i class="zmdi zmdi-edit"></i>
                                                            </a>
                                                            @endif
                                                            @if(has_access('delete_project'))
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Delete" onclick="deleteModalShow({{ $project->id }})">
				...
				<div class="modal-dialog modal-sm" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="staticModalLabel">Delete Project</h5>
						...
						<div class="modal-body">
							<p>
								Are you sure? Assigned employee tasks related to this project will also be deleted.
							</p>
...
<script>
    ...
    function descModalShow(id){
        ...
        //alert(description);
        $("#projectDetailsWrapper").html(description);
