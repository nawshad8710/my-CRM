                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.site-info.store') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <img id="Logo" src="{{ asset('assets/images/defaultimage.png') }}" height="43px"
                                            width="180px" alt="your image" />
                                        <div class="mb-3">
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <textarea name="short_description" id="description" rows="5"
                                                ...
                                                required>{{ $siteInfo->short_description ?? old('short_description') }}</textarea>
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <textarea name="meta_description" id="meta_description" rows="5"
                                                ...
                                                required>{{ $siteInfo->short_description ?? old('meta_description') }}</textarea>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <textarea name="address" id="description" rows="5"
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <textarea name="google_map_url" id="google_map_url" rows="5"
                                                    ...
                                                    required>{{ $siteInfo->google_map_url ?? old('google_map_url') }}</textarea>
...
{{-- Create Modal --}}
<div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true"
    data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.our-achive.storeAchiveItem') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="title" name="title" type="text"
                                        class="form-control @error('title') is-invalid @enderror" value="" required>
                                    @error('title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="sub_title" name="sub_title" type="text"
                                        class="form-control @error('sub_title') is-invalid @enderror" value="" required>
                                    @error('sub_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
