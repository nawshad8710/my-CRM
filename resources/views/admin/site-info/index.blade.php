...
<div class="main-content">
    <div class="section__content section__content--p30" style="float: right">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.site-info.store') }}" method="post"
                    ...
                    <div class="row">
                        <div class="col-6">
                            <img id="Logo" src="{{ asset('assets/images/uploads/site-info/logo/' . $siteInfo->logo) ?? asset('assets/images/defaultimage.png') }}" height="43px" width="180px" alt="your image" />
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <img id="FavIcon" src="{{ asset('assets/images/uploads/site-info/fav-icon/' . $siteInfo->fav_icon) ?? asset('assets/images/defaultimage.png') }}"
