                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Employee List</h3>
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <a href="{{ route('admin.employee.add') }}" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                                ...
                                                <tr class="tr-shadow">
                                                    <td class="photo">
                                                        <div class="table-data-feature">
                                                            <img class="item" src="{{ asset('assets/images/uploads/users') }}/{{ $employee->photo }}" alt="{{ $employee->name }} image">
                                                        </div>
                                                    </td>
                                                    <td>{{ $employee->name }}</td>
                                                    ...
                                                    <td class="desc">{{ $employee->designation }}</td>
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            ...
                                                            <a href="{{ route('admin.employee.edit', $employee->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <i class="zmdi zmdi-edit"></i>
                                                            </a>
                                                            @endif
                                                            @if(has_access('delete_employee'))
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Delete" onclick="deleteModalShow({{ $employee->id }})">
