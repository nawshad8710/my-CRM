<aside class="menu-sidebar d-none d-lg-block">
    <div class="logo">
        <a href="#">
            <span style="font-size: 25px;color: #ffffff;font-weight: 600;">CIT Admin</span>
        </a>
    </div>
                ...
                @if (has_menu('c_sales'))
                    <li class="has-sub {{ Request::is('admin/sales*') ? 'active' : '' }}">
                        ...
                        <ul class="list-unstyled navbar__sub-list js-sub-list"
                            ...
                            @if (has_access('sales'))
                                <li class="{{ Request::is('admin/sales/list') ? 'active' : '' }}">
                                    <a href="{{ route('admin.sales.renewableList') }}">
                                        <i class="fas fa-tasks"></i>Renewable Sales</a>
                                </li>
                            @endif
                            ...
                            @endif
                            @if (has_access('sales'))
                                <li class="{{ Request::is('admin/sales/customer-query/list') ? 'active' : '' }}">
                                    <a href="{{ route('admin.sales.query.list') }}">
                                        <i class="fas fa-tasks"></i>Customer Queries</a>
                                </li>
                            @endif
                        </ul>
                    </li>
