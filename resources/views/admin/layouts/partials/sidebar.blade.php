        ...
        <nav class="navbar-sidebar2">
            <ul class="list-unstyled navbar__list">
                ...
                <li class="has-sub {{Request::is('admin/sales*') ? 'active':''}}">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list" @if(Request::is('admin/sales*'))
                ...
                <li class="has-sub {{Request::is('admin/role*') ? 'active':''}}">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list" @if(Request::is('admin/role*'))
                        style="display: block;" @endif>
                ...
                <li class="has-sub {{Request::is('admin/employee*') ? 'active':''}}">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list" @if(Request::is('admin/employee*'))
                        style="display: block;" @endif>
                ...
                <li class="has-sub {{Request::is('admin/project*') ? 'active':''}}">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list" @if(Request::is('admin/project*'))
                        style="display: block;" @endif>
                ...
                <li class="has-sub {{Request::is('admin/assignment*') ? 'active':''}}">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list" @if(Request::is('admin/assignment*'))
                        style="display: block;" @endif>
                ...
                <li class="has-sub {{Request::is('admin/customer*') ? 'active':''}}">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list" @if(Request::is('admin/customer*'))
                        style="display: block;" @endif>
