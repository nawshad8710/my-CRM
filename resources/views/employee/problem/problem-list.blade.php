                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        @isset($problem->solution)
                                                            @if ($problem->solution->first())
                                                                <button
                                                                    onclick="viewSolutionModal({{ $problem->solution->id }})"
                                                                    class="item" data-toggle="tooltip" data-placement="top">
                                                                    <i class="zmdi zmdi-eye"></i>
                                                                </button>
                                                            @endif
                                                        @endisset (count($solution) > 0)
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
...
@push('js')
    ...
    <script>
        function viewSolutionModal(id) {
            $('#solutionModal').modal("show");
            console.log(id)
            var url = window.location.origin + "/employee/problem/get-solution/" + id;
            console.log(url)
            $.ajax({
                type: "GET",
                url: url,
                dataType: "JSON",
                success: function(response) {
                    var solutionImage = response.solutionImage;
                    var imageResult = '';
                    var solutionDescription = response.solution.description;
                    for (var i = 0; i < solutionImage.length; i++) {
                    ...
                    $('.viewImage').html(imageResult);
                    $('#solutionDescription').html(solutionDescription);
